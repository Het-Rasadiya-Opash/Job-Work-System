...
export default function AuthPage() {
  ...
  const toggle = () => {
    setIsSignup((p) => !p);
    setForm(isSignup ? initialSignin : initialSignup);
    setError("");
  };
  ...
  const inputSx = {
    "& .MuiOutlinedInput-root": {
      borderRadius: "8px",
      backgroundColor:
        theme.palette.mode === "dark" ? "rgba(255,255,255,0.04)" : "#F9FAFB",
      fontSize: "13.5px",
    ...
    >
      <Box sx={{ width: "100%", maxWidth: 400 }}>
        ...
        >
          ...
          >
            <Typography fontSize="12px" fontWeight={800} color="#fff">
              JW
            </Typography>
          </Box>
          <Typography
        ...
        <Paper sx={{ borderRadius: "12px", overflow: "hidden" }}>
          ...
          <Box sx={{ px: 3, pt: 3, pb: 0 }}>
            ...
            <Typography variant="body1" color="text.secondary" mt={0.5}>
              {isSignup
                ? "Get started with JobWork"
                : "Welcome back to JobWork"}
            </Typography>
          </Box>
